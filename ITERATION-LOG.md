...
# 7. Create the Iteration Log on GitHub
...
5. Copy the contents of this document into the file.
6. Scroll to the bottom.
7. Enter this commit message:

`Add iteration log and version history`

8. Click **Commit changes**.

---

# 8. How to Show a Real Iteration

For each prompt you actually improve:
...
`P04-social-captions-v1.md`

### After testing

Create the improved version:

`P04-social-captions-v1.1.md`

or update the existing prompt file and use GitHub's commit history to show the change.

### Commit the change

Use a specific message, for example:

`Improve P04 with role framing and format constraints`

This is better than a vague message such as:

`Changed prompt`

because the assessor can immediately understand what was changed.

---

# 9. How to Check Your Commit History

After making changes:

1. Open your GitHub repository.
2. Near the top of the file list, click the **commits** link.
3. You will see your commit history.
4. Click an individual commit to see what changed.
5. Use this history as evidence of prompt iteration.

A good iteration history should show a clear progression:

**Initial prompt → test/problem → prompt revision → improved version**

---

# 10. Recommended Repository Structure

Your GitHub repository should ideally look like this:
...
This follows the folder structure already specified in the prompt library.

---

# 11. What You Should NOT Do

- Do not claim that you tested a prompt if you did not test it.
- Do not invent output results or performance statistics.
- Do not create fake GitHub commits with false dates.
- Do not claim that a prompt is fully automated when the source identifies a need for human review.
- Do not automatically publish crisis/reputation responses.
- Do not add unsupported facts to the audience persona.
- Do not delete the original version if the assessment requires evidence of iteration.

---

# 12. Final Submission Checklist

Before submitting the GitHub link, check:

- [ ] Repository has the correct name.
- [ ] `README.md` is present.
- [ ] `Prompt-Library.md` is present.
- [ ] `ITERATION-LOG.md` is present.
- [ ] All 10 prompts are included.
- [ ] Prompts are organised into the four workflow folders.
- [ ] Iterated prompts have clear version changes.
- [ ] GitHub commit history shows meaningful changes.
- [ ] Commit messages explain what changed.
- [ ] Risks and human-review requirements are documented.
- [ ] No unsupported test results have been added.
- [ ] Repository link is added to the assessment where required.

---

## 13. Important Evidence for the Assessment

The supplied Prompt Library identifies that the prompt versions should be documented and that GitHub/OneDrive commit history should be used as the version log. It specifically records iterations for P02, P04, P05, P08, P09 and P10.

The supplied library also identifies the key prompting strategies used across the project, including role framing, structured outputs, constraints, decomposition, refinement/self-checking and grounding in real data.

Use this document together with the actual prompt files and your real GitHub commit history. The commit history should provide the evidence of how the prompts changed over time.
