...
### v1.1
Decomposed the workflow into action-item extraction followed by email drafting.

## Iteration Rationale
The decomposition helps ensure action items are identified before the follow-up email is drafted.
